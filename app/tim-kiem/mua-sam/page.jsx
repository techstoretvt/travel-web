...
function TimDiaDiem({ params }) {
    ...
    const [loaiMuaSam, setLoaiMuaSam] = useState('all')
    ...
    useEffect(() => {
        if (!loading)
            handleGetDiemDen()
    }, [loaiMuaSam, khuVuc, oGan, currentPage])
    ...
    const handleGetDiemDen = async () => {
        try {
            ...
            let res = await fetch(process.env.BACKEND + '/api/get-diem-den?type=' + loaiMuaSam + '&khu_vuc=' + khuVuc + '&o_gan=' + oGan + '&city=' + city + '&page=' + currentPage)
            ...
            <div className={styles.filters}>
                <div className={styles.filter}>
                    ...
                    <Select
                        ...
                        onChange={(value) => onchangeFilter(value, setLoaiMuaSam)}
                        options={[
                            {
                                label: 'Tất cả',
                                value: 'all',
